...
export const INLINE_REALTIME_MAX_BYTES =
  parsePositiveInt(process.env.NEXT_PUBLIC_WITHMD_INLINE_REALTIME_MAX_BYTES) ?? DEFAULT_INLINE_REALTIME_MAX_BYTES;
...
export function isRealtimeSyntaxUnsafeMarkdown(markdown: string): boolean {
  void markdown;
  return false;
}
